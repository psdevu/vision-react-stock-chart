...
var _RulerText = require('../components/RulerText');

var _RulerText2 = _interopRequireDefault(_RulerText);
      ...
      value: function render() {
        ...
        if (_props6.type === 'RULER') {
          ...
          return _react2.default.createElement(
            ...
            line1,
            line2,
            _react2.default.createElement(_RulerText2.default, {
              ref: this.saveNodeType('channel'),
              show: selected || hover,
              ...
              y2Value: endXY[1],
              r: r,
              fill: dy && Math.sign(dy) >= 0 ? '#2863FF' : '#ef5350',
              fillOpacity: 1,
              textColor: '#eee',
              fontSize: 16,
